...
3. **Presentations**: You will present three papers throughout the course of the semester. A list of potential papers is available on the syllabus, with additional details regarding presentation expectations and grading available [here](assignments/presentation.html). Please inform me of your selected papers no later than **September 2** by indicating your paper and date of presentation on the Google Sheet, available [here]([here](https://docs.google.com/spreadsheets/d/1d6IVg-khbreLKobiczNwEOT9gjPNNykrFEtc2rXdJ4I/edit?usp=sharing).
