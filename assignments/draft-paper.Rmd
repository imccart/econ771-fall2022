...
# Overview
This describes the expectations for the draft paper. This is only required for 3rd year students. For 2nd year students, you need only submit a literature review. Details of the lit review assignment are [here](assignments/lit-review.html). Your draft paper is due no later than **Tuesday, November 24, 2020**.
...
You will "turn in" your repository to me with your paper and all supporting documents. Please create a final document with your main paper in a PDF. Please also be sure to include in your repository all of your supporting code files. Practice writing good code and showing me only what I would need to recreate your results.
...
# Grading
Your grade will be based on 10 items, each worth 10 points toward the final assignment grade. For each component, you'll receive a 0 (not present), 5 (the element is there but poorly executed), or 10 (element is there and sufficiently executed). The 10 elements are listed below:
...
6. Results
7. Discussion of robustness and sensivity (not expected to be completed, just listed out)
