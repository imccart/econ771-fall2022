...
## [Module 0: Kicking things off!](modules/module0.html)
  ...
  - `r advdate(1)`: Introduction to the economics of healthcare and causal inference. Slides [part 1](slides/01-intro-health.html) and [part 2](slides/01-intro-causal-inference.html)

## [Module 1: Hospitals](modules/module1.html)

  - `r advdate(2)`: Background and institutional details. Slides [on background](slides/01-1.html), [Pablo](slides/student/pablo-20220829.pdf), [Katie](slides/student/katie-20220829.pdf)
